...
class patientReg:
    def __init__(self):
        ...
        self.root1 = tk.Tk()
        self.root1.title("Patients Form")
    ...
    def set_background(self):
        background_frame = tk.Frame(self.root1, background='#961C51', width=self.window_width,
    ...
    def create_gui(self):
        ...
        def submit_appointment():
            patient_id = pat_no
            messagebox.showinfo("Patient Booking", f"successfully booked\n\tpatient_id={patient_id}")
            response = messagebox.askyesno("Continue?", "Do you want to add another patient?")
            if response:
                # Rerun the interface
        ...
        def register():
            if validate_form():
                ...
                patconnectsql.insert_patient1_data(pat_no, firstname, lastname, ph_no, email, address, age, dob, blood,
                                                    doctor)
                submit_appointment()
